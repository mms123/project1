...
function loop() {
    if (isPlaying) {
        ...
        if (jet1.score>50) window.open ('index1.html','_self',false);
    }
}
...
var level1_button = document.getElementById('clearCanvasBtn1');
level1_button.addEventListener('click',level1,false);

function level1() {
window.open ('index1.html','_self',false);
}
